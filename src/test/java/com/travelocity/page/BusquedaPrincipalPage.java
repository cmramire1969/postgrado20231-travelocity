...
public class BusquedaPrincipalPage {
    ...
    public static Target FECHA_1 = Target.the("fecha in seleccion").locatedBy("//button[@aria-label='{0} de abril de 2023']");
   ...
   public static Target BUSQUEDA_ACTIVIDAD = Target.the("boton buscar actividad").locatedBy("//span[text()='Actividades']/..");
    ...
    public static Target BUT_AUTO_ORIGEN3 = Target.the("origen").locatedBy("//button[@data-stid='location-field-locn-menu-trigger']");
